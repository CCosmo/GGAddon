...
public class ChatUtils {
    ...
    public void connectedToGG(String locale) {
        ...
        space();
        headerAndFooter();
        GGAddon.getInstance().getClient().initChatClient();
    }
    ...
    public void sendOnlineChat(String message) {
        LabyMod.getInstance().displayMessageInChat("§7[§6GGOnlineChat§7] §r" + message);
    }
