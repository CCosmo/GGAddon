...
public class GGAddon extends LabyModAddon {
    ...
    public static GGAddon getInstance() { return addon; }

    public ChatUtils getChat() { return cu; }

    public GAddonManager getAddonManager() { return addonManager; }

    public GCommandManager getCommandManager() { return commandManager; }
